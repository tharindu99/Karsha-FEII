...
/**
 * EjAttributesActiveId generated by hbm2java
 */
@Embeddable
public class EjAttributesActiveId implements java.io.Serializable {

	private String idRssd;
	private String DDtStart;

	public EjAttributesActiveId() {
	}

	public EjAttributesActiveId(String idRssd, String DDtStart) {
		this.idRssd = idRssd;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EjAttributesActiveId))
			return false;
		EjAttributesActiveId castOther = (EjAttributesActiveId) other;
