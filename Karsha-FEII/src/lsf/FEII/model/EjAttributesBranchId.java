...
/**
 * EjAttributesBranchId generated by hbm2java
 */
@Embeddable
public class EjAttributesBranchId implements java.io.Serializable {

	private String idRssd;
	private String DDtStart;

	public EjAttributesBranchId() {
	}

	public EjAttributesBranchId(String idRssd, String DDtStart) {
		this.idRssd = idRssd;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EjAttributesBranchId))
			return false;
		EjAttributesBranchId castOther = (EjAttributesBranchId) other;
